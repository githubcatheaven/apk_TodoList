...
/**
 * Material Design 3 Typography scale for the Todo application.
 * 
 * Provides a comprehensive set of text styles following Material Design 3 guidelines
 * with appropriate font sizes, weights, line heights, and letter spacing.
 */
